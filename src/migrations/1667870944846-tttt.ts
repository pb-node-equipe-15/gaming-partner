...
export class tttt1667870944846 implements MigrationInterface {
    name = 'tttt1667870944846'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "conections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "conetionsId" uuid, CONSTRAINT "PK_b03e5a5ef0897d70fef304577a4" PRIMARY KEY ("id"))`);
