...
export class createEntities1668027984814 implements MigrationInterface {
    name = 'createEntities1668027984814'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "conections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "userConectionsId" uuid, CONSTRAINT "PK_b03e5a5ef0897d70fef304577a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users_games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "usersId" uuid, "gamesId" uuid, CONSTRAINT "PK_7373732a33c22813c5e06f4b4c1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "conections" ADD CONSTRAINT "FK_cf2406ed1008778e920534a64aa" FOREIGN KEY ("userConectionsId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "conections" DROP CONSTRAINT "FK_cf2406ed1008778e920534a64aa"`);
