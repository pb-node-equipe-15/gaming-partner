...
categoriesRouter.post('', authMiddleware, adminMiddleware, addCategoryController);
categoriesRouter.post('/:id', authMiddleware, adminMiddleware, addGamesToCategoryController);
